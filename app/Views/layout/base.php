...
<div class="sidebar">
    ...
    <div class="menu">
        ...
        <a href="controleurFrontal.php?action=index&controleur=Vente" class="<?= $activePage == 'ventes' ? 'active' : '' ?>">Ventes</a>
        <a href="controleurFrontal.php?action=index&controleur=Parametre" class="<?= $activePage == 'parametres' ? 'active' : '' ?>">Paramètres</a>
        <a href="controleurFrontal.php?action=index&controleur=Suivis" class="<?= $activePage == 'mes_suivis' ? 'active' : '' ?>">Mes suivis</a>
        <a href="controleurFrontal.php?action=index&controleur=Utilisateur" class="<?= $activePage == 'compte' ? 'active' : '' ?>">Compte</a>
        <a href="controleurFrontal.php?action=index&controleur=Aide" class="<?= $activePage == 'aide' ? 'active' : '' ?>">Aide</a>
    </div>
</div>
